...
export const AUDIT_ACTIONS = {
  ...
  CERT_TEMPLATE_CREATED:  'CERT_TEMPLATE_CREATED',
  CERT_TEMPLATE_UPDATED:  'CERT_TEMPLATE_UPDATED',
  CERT_CHECKLIST_STARTED: 'CERT_CHECKLIST_STARTED',
  CERT_CHECKLIST_ANSWER_UPDATED: 'CERT_CHECKLIST_ANSWER_UPDATED',
  CERT_CHECKLIST_SUBMITTED: 'CERT_CHECKLIST_SUBMITTED',
  CERT_CHECKLIST_APPROVED:  'CERT_CHECKLIST_APPROVED',
  CERT_CHECKLIST_REJECTED:  'CERT_CHECKLIST_REJECTED',
  // Crop
